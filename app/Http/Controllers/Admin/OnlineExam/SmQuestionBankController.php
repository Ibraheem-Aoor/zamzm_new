...
{
    public function __construct(protected QuestionBankService $question_bank_service)
    {
        $this->middleware('PM');
        // User::checkAuth();
    }
    ...
    {
        return $this->question_bank_service->store($request);
    }
    ...
    {
        return $this->question_bank_service->update($request, $id);
    }
