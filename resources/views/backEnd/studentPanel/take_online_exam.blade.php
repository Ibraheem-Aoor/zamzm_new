                                                ...
                                                <h3 class="mb-20"><strong>@lang('exam.total_marks') : </strong>
                                                    @php
                                                        ...
                                                        foreach ($online_exam->assignQuestions as $question) {
                                                            $total_marks =
                                                                $total_marks + $question->questionBank->marks;
                                                        }
                                                        echo @$total_marks;
                                                    @endphp</h3>
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <p class="mb-2"><strong>@lang('exam.exam_has_to_be_submitted_within'):
                                                            </strong>{{ @$online_exam->date }}
                                                            {{ @$online_exam->end_time }}</p>
                                                        ...
                                                        @foreach ($multiple_options as $multiple_option)
                                                            <div class="mt-20">
                                                                <input data-question = "{{ @$question->question_bank_id }}"
                                                                    ...
                                                                    value="{{ $multiple_option->id }}"
                                                                    {{ isset($submited_answer) ? ($submited_answer->user_answer == $multiple_option->id ? 'checked' : '') : '' }}>
                                                                <label
                                                                    for="answer{{ @$multiple_option->id }}">{{ @$multiple_option->title }}</label>
                                                            </div>
                                                        @endforeach
                                                                ...
                                                                <div class="single_upload_img">
                                                                    <div class="img_check">
                                                                        <input
                                                                            ...
                                                                            name="options_{{ @$question->question_bank_id }}"
                                                                            value="{{ $multiple_option->id }}"
                                                                            {{ isset($submited_answer) ? (in_array($multiple_option->id, $submited_answer) ? 'checked' : '') : '' }}>
                                                                        <label
                                                                            for="answer{{ @$multiple_option->id }}"></label>
                                                                        {{-- {{@$multiple_option->title}}  --}}
                                                                    </div>
                                                                    <img src="{{ asset($multiple_option->title) }}"
                                                                        alt="">
                                                                </div>
                                                            @endforeach
                                                        </div>
                                                        ...
                                                        <div class="d-flex radio-btn-flex mt-20">
                                                            <div class="mr-30">
                                                                <input data-question = "{{ @$question->question_bank_id }}"
                                                                    ...
                                                                    value="T"
                                                                    {{ isset($submited_answer) ? ($submited_answer->user_answer == 'T' ? 'checked' : '') : '' }}
                                                        ...
                                                        <div class="row">
                                                            <div class="col-10">
                                                                <div class="primary_input mt-20">
                                                                    ...
                                                                    <textarea class="primary_input_field form-control mt-10 form_filler_{{ @$question->question_bank_id }}"
                                                                        name="answer_word_{{ @$question->question_bank_id }}" id="answer_word_{{ @$question->question_bank_id }}">{{ isset($submited_answer) ? $submited_answer->user_answer : '' }} </textarea>
